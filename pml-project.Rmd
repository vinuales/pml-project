...
Based on the provided dataset, we'll try to train a predictive model to predict what exercise was performed using a dataset with 159 features
...
We'll use 200 trees, because I've already seen that the error rate doesn't decline a lot after 50 trees.
